...
export default function Anagramme({ guestMode, guestListId, onGameEnd }: AnagrammeProps) {
  ...
  const [resultats, setResultats] = useState<{
    mot: string; translation: string; correct: boolean; attemptsBeforeSuccess: number; usedOptionalHint: boolean
  }[]>([])
              ...
              <div key={i} style={{ display: 'flex', alignItems: 'center', padding: '0.5rem 0', borderBottom: '1px solid #f5f5f5', gap: '0.75rem' }}>
                ...
                <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '0.15rem', fontSize: '0.85rem' }}>
                  <span style={{ color: '#555' }}>
                    <strong>{r.mot}</strong>
                    <span style={{ marginLeft: '0.4rem', fontSize: '0.75rem', color: '#aaa', fontStyle: 'italic' }}>
                      {r.translation}
                    </span>
                  </span>
