...
import type { Child, IrlRewardSimple, Mission } from './types'

interface ParentMissionsProps {
  children: Child[]
  irlRewardsList: IrlRewardSimple[]
}

export default function ParentMissions({ children, irlRewardsList }: ParentMissionsProps) {
